...
type CreateEventFormProps={
  handleCreateEvent:SubmitHandler<EventProfile>;
  onChangePicture:(event: ChangeEvent) => void;
  handleSubmit:UseFormHandleSubmit<EventProfile>;
  register:UseFormRegister<EventProfile>;
  errors:FieldErrors<EventProfile>;
  watch:UseFormWatch<EventProfile>;
  picture:string | null;
}
    ...
    <div className="-mx-3 flex flex-wrap">
      <div className="w-full px-3 sm:w-1/2">
        <div className=" mb-5">
          ...
          <ErrorsSpan errors={errors?.city} className="errors-span" />
        </div>
      </div>
      <div className="w-full px-3 sm:w-1/2">
        <div className=" mb-5">
          ...
          <ErrorsSpan errors={errors?.address} className="errors-span" />
        </div>
      </div>
    </div>
    ...
    <div className="-mx-3 flex flex-wrap">
      <div className="w-full px-3 sm:w-1/2">
        <div className=" mb-5">
          ...
          <ErrorsSpan errors={errors?.type} className="errors-span" />
        </div>
      </div>
      <div className="w-full px-3 sm:w-1/2">
        <div className=" mb-5">
